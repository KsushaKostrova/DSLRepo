...
public class Main {
  ...
  protected void runGenerator(final String string) {
    ...
    this.fileAccess.setOutputPath("/home/ksusha/runtime-EclipseXtext/dsl-project/src-gen/");
    ...
    System.out.println(this.fileAccess.getURI("src-gen/"));
    System.out.println(this.fileAccess.getOutputConfigurations());
  }
}
