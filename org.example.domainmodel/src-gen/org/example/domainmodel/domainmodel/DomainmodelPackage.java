...
public interface DomainmodelPackage extends EPackage
{
   ...
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see org.example.domainmodel.domainmodel.impl.MethodImpl
   * @see org.example.domainmodel.domainmodel.impl.DomainmodelPackageImpl#getMethod()
   * @generated
   */
  int METHOD = 8;
  ...
  /**
   * Returns the meta object for the containment reference list '{@link org.example.domainmodel.domainmodel.Entity#getMethods <em>Methods</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Methods</em>'.
   * @see org.example.domainmodel.domainmodel.Entity#getMethods()
   * @see #getEntity()
   * @generated
   */
   ...
   * @see org.example.domainmodel.domainmodel.Method
   * @generated
   */
  EClass getMethod();

  /**
   * Returns the meta object for the attribute '{@link org.example.domainmodel.domainmodel.Method#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see org.example.domainmodel.domainmodel.Method#getName()
   * @see #getMethod()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link org.example.domainmodel.domainmodel.Method#getBody <em>Body</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Body</em>'.
   * @see org.example.domainmodel.domainmodel.Method#getBody()
   * @see #getMethod()
   * @generated
   */
