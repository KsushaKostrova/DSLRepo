...
public class DomainmodelGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class EntityElements extends AbstractParserRuleElementFinder {
		...
		//'entity' name=ID ('extends' superType=[Entity|QualifiedName])? '{' features+=Feature* methods+=Method* '}'
		public Group getGroup() { return cGroup; }
	...
	public class MethodElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cBodyMethodBodyParserRuleCall_3_0 = (RuleCall)cBodyAssignment_3.eContents().get(0);
		
		//Method:
		//	'method' name=ID ':' body=MethodBody;
		@Override public ParserRule getRule() { return rule; }
		...
		//MethodBody
		public RuleCall getBodyMethodBodyParserRuleCall_3_0() { return cBodyMethodBodyParserRuleCall_3_0; }
	}
	public class NumElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.domainmodel.Domainmodel.Num");
	...
	public class MethodBodyElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.example.domainmodel.Domainmodel.MethodBody");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final RuleCall cQualifiedNameParserRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
		private final Keyword cLeftParenthesisKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final RuleCall cNumParserRuleCall_2 = (RuleCall)cGroup.eContents().get(2);
		...
		//Num
		public RuleCall getNumParserRuleCall_2() { return cNumParserRuleCall_2; }
