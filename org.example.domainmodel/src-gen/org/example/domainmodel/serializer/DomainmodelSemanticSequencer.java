...
public class DomainmodelSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == DomainmodelPackage.eINSTANCE)
			...
			case DomainmodelPackage.IMPORT:
				...
				return; 
			case DomainmodelPackage.METHOD:
	 ...
	 *
	 * Constraint:
	 *     (name=ID superType=[Entity|QualifiedName]? features+=Feature* methods+=Method*)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=ID body=MethodBody)
	 */
	protected void sequence_Method(ISerializationContext context, Method semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, DomainmodelPackage.Literals.METHOD__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DomainmodelPackage.Literals.METHOD__NAME));
			if (transientValues.isValueTransient(semanticObject, DomainmodelPackage.Literals.METHOD__BODY) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DomainmodelPackage.Literals.METHOD__BODY));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getMethodAccess().getNameIDTerminalRuleCall_1_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getMethodAccess().getBodyMethodBodyParserRuleCall_3_0(), semanticObject.getBody());
		feeder.finish();
	}
